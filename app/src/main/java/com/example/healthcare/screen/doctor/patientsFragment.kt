...
import com.example.healthcare.adapter.ChatPatients
...
class patientsFragment : Fragment() {
    ...
    private lateinit var adapterMe: ChatPatients
    private var arrayOfData = ArrayList<DoctorInfo>()
            ...
            firestore.collection("users")
                .get().addOnSuccessListener {
                    for (i in it.documents) {
                        ...
                        val idSick = i.id
                        var photo = i.getString("profileImage")
                    ...
                    adapterMe = ChatPatients(activity!!, arrayOfData)
